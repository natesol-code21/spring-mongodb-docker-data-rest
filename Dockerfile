...
CMD ["java","-Dspring.data.mongodb.uri=mongodb://mongodb/micros","-Djava.security.egd=file:/dev/./urandom", "-jar","/spring-mongodb-docker-data-rest/target/docker/spring-mongodb-docker-data-rest-0.1.0.jar"]
